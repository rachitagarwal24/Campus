...
public class BookFragment extends Fragment{
    ...
    private static final String URL = "http://192.168.43.47/android4/book.php";

    private static final String TAG_RESULT="result";
    private static final String BOOK_ID="subid";
    private static final String BOOK_NAME="subname";
    private static final String BOOK_WRI="fbook";
    ...
    protected void showList()
    {
        try
        {
            ...
            for(int i=0;i<news.length();i++)
            {
                ...
                newsList.add(news1);
                ListAdapter adapter=new SimpleAdapter(getActivity(),newsList,R.layout.book_main,new String[]{BOOK_ID,BOOK_NAME,BOOK_WRI},new int[]{R.id.subid,R.id.subname,R.id.fbook});
    ...
    public void getData() {
        class GetDataJSON extends AsyncTask<String,Void,String > {
            ...
            protected void onPreExecute() {
                ...
                mProgressDialog.setTitle("Loading Books name");
